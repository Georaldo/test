...
if st.button("✨ Predict Credit Risk! ✨", use_container_width=True):
    ...
    # Prompt to GPT
    prompt = f"""
    You are a business analyst writing a credit risk analysis summary for a loan applicant.
    ...
    **Applicant Information:**
    ...
    Write a concise, professional summary (100-150 words) that explains why the applicant received this risk level.
    Avoid technical terms like SHAP or model weights. Focus on explaining how applicant characteristics contribute to the credit risk in business-friendly          language.
    """
